...
//            intent.setData(Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME)));
            ...
            Intent intent3 = new Intent(context, Detail2.class);
            PendingIntent pendingIntent3 = PendingIntent.getActivity(context, 0, intent3, 0);
            rv.setOnClickPendingIntent(R.id.deviation_description, pendingIntent2);
            rv.setOnClickPendingIntent(R.id.deviation_description_time, pendingIntent2);
            rv.setOnClickPendingIntent(R.id.deviation_icon, pendingIntent2);
            ...
            rv.setOnClickPendingIntent(R.id.deviation_description_3, pendingIntent3);
            rv.setOnClickPendingIntent(R.id.deviation_description_time_3, pendingIntent3);
            rv.setOnClickPendingIntent(R.id.deviation_icon_3, pendingIntent3);
